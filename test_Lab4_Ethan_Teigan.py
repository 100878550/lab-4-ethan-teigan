...
def driver():
  ...
  service = Service("C:/Users/ethan/Desktop/chromedriver-win64/chromedriver.exe")
  driver = webdriver.Chrome(service=service)  # Ensure chromedriver is in PATH
  driver.maximize_window()


def test_lab4EthanTeigan(driver):
